...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-3.5 data-[state=unchecked]:-translate-x-1",
      )}
    />
  </SwitchPrimitives.Root>
));
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none flex h-8 w-8 items-center justify-center rounded-full bg-white shadow-lg ring-0 transition-transform dark:bg-dark-bg",
