...
const ManagerSettingPage = () => {
  ...
  return (
    <div
      ...
      <div data-tour="step-19" className="grid h-full w-full" style={{ gridTemplateColumns: "1fr 6fr" }}>
        <div
          ...
          <ListItem button component={Link} to="./holidaysetting" selected={isSelected("holidaysetting")}>
