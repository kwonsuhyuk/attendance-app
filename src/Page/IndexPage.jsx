...
function IndexPage() {
  ...
  return (
    <div className="bg-dark-bg w-screen h-screen relative flex justify-center">
      ...
      <div
        className="w-64 h-64 rounded-full absolute top-48 left-16"
        style={{ backgroundColor: "#4747474D" }}></div>
      <div
        className="hidden xl:block absolute top-1/3 right-1/3 text-dark-text text-7xl"
        style={{ letterSpacing: 50 }}>
        Att-App
      </div>
      <div
        className="text-dark-text font-black text-xl absolute bottom-1/4 w-full text-center cursor-pointer"
