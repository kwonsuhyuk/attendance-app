...
function IndexPage() {
  ...
  return (
    <div className="overflow-hidden w-screen h-screen">
      <div className="bg-black text-white text-center h-screen w-screen overflow-hidden flex flex-col justify-between">
        ...
        <div
          ...
          style={{ border: "solid 1px #FFFFFF80" }}></div>
        <div className="flex justify-center relative overflow-hidden h-[38%]">
          ...
          <div className="absolute w-[300vw] h-[300vh] left-1/2 -translate-x-1/2 bg-white rounded-full flex flex-col items-center justify-center z-10" />
        </div>
      </div>
      <div
        className="absolute w-[120vw] h-[120vh] -left-[40%] -top-[15%] rounded-full"
        style={{
      ...
      />
      <div
        className="absolute w-[200vw] h-[200vh] left-[25%] top-[13%] rounded-full"
        style={{
